...
public class ReflectionTestUtils {
    public static Field findNonPrimitiveField(final Class<?> classToSearch, final Class<?> fieldType)
    ...
    public static void setNonPrimitiveField(final Class<?> classToSearch, final Class<?> fieldType,
	    final Object classInstance, final Object value) throws SecurityException, IllegalAccessException {

	final Field field = findNonPrimitiveField(classToSearch, fieldType);
	field.set(classInstance, value);
    }

    public static void setPrimitiveField(final Class<?> classToSearch, final Class<?> fieldType,
	    final String fieldName, final Object classInstance, final Object value) throws SecurityException,
